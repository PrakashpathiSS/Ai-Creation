...
| `<UNK>` | **Unknown**               | Represents a token that is not in the vocabulary. |
| `<BOS>` | **Beginning Of Sequence** | Marks the start of a sentence or document.        |
| `<EOS>` | **End Of Sequence**       | Marks the end of a sentence or document.          |
